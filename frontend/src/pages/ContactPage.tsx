          ...
          <div className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-3xl shadow-xl p-8 border border-emerald-100">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-700 max-w-3xl mx-auto leading-relaxed">
                Hệ thống hỗ trợ xử lý API <span className="font-semibold text-emerald-700">Google Docs, Google Sheets, Excel, Word</span>. 
                <span className="text-sm text-gray-600 block mt-2">(Tính năng PDF và trích xuất thông tin từ <span className="font-semibold text-emerald-700">link có hình ảnh</span> đang được phát triển)</span>
              </p>
            </div>
          </div>
